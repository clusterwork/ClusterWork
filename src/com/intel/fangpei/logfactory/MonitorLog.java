...
public class MonitorLog extends ClusterMonitorLog {
	...
	public MonitorLog() throws Exception {
		...
		String logpath = ConfManager.getConf("log.path");
		//System.out.println("log path:"+logpath+":"+this.className);
		File dir = new File(logpath);	
		if(!dir.isDirectory() || !dir.exists()){
			if(!dir.mkdirs()){
				throw new Exception("cann't make log dir ,please check:"+dir.getPath());
			}
		}
