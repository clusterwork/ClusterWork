...
public static boolean istarted(int jvmId){
	if(alreadyStarted.contains(jvmId)){
		return true;
	}
	return false;
}
public static boolean istarted(Set<Integer> set){
	return alreadyStarted.containsAll(set);
}
